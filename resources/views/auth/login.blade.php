<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Emailsss')" />
        ...
        <!-- Remember Me -->
        <div class="space-x-36 -mt-4 mb-4" >
        ...
        @if (Route::has('register'))
                <a
                    href="{{ route('register') }}"
                    class="text-center font-serif  text-xs py-2 text-gray text-gray-600  hover:text-black-600 "
                    >
